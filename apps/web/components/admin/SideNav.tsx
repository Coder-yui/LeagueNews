...
import { Activity, ArrowLeft, BookOpen, CalendarDays, Database, FileText, Menu, ScanText, Settings, ShieldCheck, X } from "lucide-react";
import { useState } from "react";

const groups = [
  { label: "", items: [{ href: "/admin/pipeline", label: "流水线监控", icon: Activity }] },
  { label: "内容", items: [{ href: "/admin/messages", label: "消息管理", icon: FileText }, { href: "/admin/reports", label: "日报管理", icon: CalendarDays }] },
