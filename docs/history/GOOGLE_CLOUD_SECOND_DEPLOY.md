...
- 重新导出的微博生产 Cookie 共 20 条且包含 `SUB`、`SUBP`；云端真实运行 `英雄联盟赛事`
  Source 成功采集 10 条，发布时间覆盖北京时间 2026-08-15 19:47 至 2026-08-16 13:00。
  这 10 条均完成自动 Pipeline、发布和事件聚合。由于本批达到上限，下一批按 60 分钟硬间隔继续
  向北京时间 2026-08-15 18:00 水位扫描；8 个微博 Source 随后全部启用并错峰运行。
